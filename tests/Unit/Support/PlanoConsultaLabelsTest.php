...
it('no Licitação inclui as 2 certidões federais (CND Federal, FGTS) sem parecer fiscal e sem CNDT', function () {
...
it('inclui FGTS e certidões estaduais/municipais a partir do Compliance, sem CNDT', function () {
