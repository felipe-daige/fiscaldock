        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 pt-8 border-t border-gray-200">
                ...
                <div class="flex items-center gap-4">
                    <a href="#" class="text-[11px] text-gray-400 uppercase tracking-wide hover:text-gray-600 transition-colors">Termos de Uso</a>
                    <span class="text-gray-300">·</span>
                    <a href="#" class="text-[11px] text-gray-400 uppercase tracking-wide hover:text-gray-600 transition-colors">Privacidade</a>
                </div>
            </div>
        </div>
    </footer>
