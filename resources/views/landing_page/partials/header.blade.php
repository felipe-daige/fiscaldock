<header class="bg-white border-b border-gray-200 sticky top-0 z-50 {{ $isLoginView ? '' : 'shadow-sm' }}">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex justify-between items-center {{ $isLoginView ? 'py-4' : 'py-6' }}">
            ...
            <ul class="hidden md:flex items-center gap-8">
                ...
                <li class="flex items-center"><a href="/faq" class="text-gray-600 hover:text-gray-900 transition-colors font-medium inline-flex items-center" style="min-height: 40px; line-height: 1.2;">FAQ</a></li>
                ...
                <li class="flex items-center">
                    <a href="/agendar" class="{{ $isLoginView ? 'inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50' : 'btn-cta btn-cta--nav inline-flex items-center' }}" style="min-height: 40px;">
                        {{ $isLoginView ? 'Abrir Conta' : 'Testar Agora' }}
                    </a>
                </li>
            </ul>
        ...
        <div id="mobile-menu" class="hidden md:hidden flex-col gap-4 py-4 border-t border-gray-200">
            ...
            <a href="/faq" data-link class="text-gray-600 hover:text-gray-900 transition-colors font-medium py-2">FAQ</a>
            ...
            <a href="/agendar" data-link class="{{ $isLoginView ? 'w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50' : 'btn-cta btn-cta--block w-full' }}">
                {{ $isLoginView ? 'Abrir Conta' : 'Testar Agora' }}
            </a>
        </div>
    </div>
