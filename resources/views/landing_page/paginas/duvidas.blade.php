@php
    ...
    $faqs = [
        ['q' => 'O que é o FiscalDock e como ele ajuda meu escritório contábil?', 'a' => 'O FiscalDock é uma plataforma de inteligência fiscal para contadores e escritórios contábeis. Ele importa seus arquivos EFD SPED (ICMS/IPI e PIS/COFINS) e XMLs de notas fiscais, cruza os dados automaticamente com fontes oficiais como a Receita Federal, PGFN, SEFAZ, TST e Caixa, e gera alertas quando detecta riscos — como fornecedores com CNPJ irregular, inscrição estadual suspensa ou divergências em notas fiscais. Em vez de verificar manualmente cada participante, você tem dashboards interativos com a situação fiscal de todos os seus clientes.'],
        ...
        ['q' => 'O que são as Consultas de CNPJ e como funciona o saldo pré-pago?', 'a' => 'O módulo de Consultas verifica a situação cadastral de CNPJs em lote — tanto participantes extraídos dos SPEDs quanto qualquer CNPJ avulso. Usamos a Receita Federal (consulta gratuita, não consome saldo) e consultas premium em sistemas públicos oficiais. O sistema funciona com saldo pré-pago em reais: você adiciona saldo e cada consulta tem preço fixo por produto.'],
        ...
        ['q' => 'Posso testar o FiscalDock antes de adicionar saldo?', 'a' => 'Sim. O período de teste gratuito inclui importação de SPED, dashboards, alertas e consultas de CNPJ. Você pode importar arquivos reais e avaliar os resultados antes de adicionar saldo. Observações: consultas premium em bases públicas consomem saldo mesmo durante o teste, porque toda chamada tem custo real; e o módulo de Clearance ainda está em construção, portanto não está disponível no trial.'],
        ['q' => 'Quanto de saldo é ideal para meu escritório?', 'a' => 'Depende do volume de consultas e da rotina do seu time. Escritórios menores podem começar com pouco saldo e adicionar conforme o uso real. Cada consulta tem preço fixo por produto — sem surpresas. Confira a página de preços para comparar valores e custos por consulta.'],
    ];
@endphp
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Encontre respostas sobre importação de SPED, validação fiscal, segurança dos dados, saldo e preços
            </p>
        </div>
        ...
        <div class="flex justify-center mb-10">
            <div class="inline-flex flex-wrap justify-center gap-2 bg-gray-50 rounded-lg p-1.5 border border-gray-200">
                ...
                <button class="duvidas-cat-btn px-4 py-2 rounded-md font-semibold text-sm transition-all duration-200 text-gray-600 hover:text-gray-900 hover:bg-white"
                        data-category="planos">Saldo e Preços</button>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="primeiros-passos">
                ...
                <div class="duvidas-answer hidden">
                    <div class="px-6 py-4 text-gray-600 bg-white border-t border-gray-100">
                        O FiscalDock é uma plataforma de inteligência fiscal para contadores e escritórios contábeis. Ele importa seus arquivos EFD SPED (ICMS/IPI e PIS/COFINS) e XMLs de notas fiscais, cruza os dados automaticamente com fontes oficiais como a Receita Federal, PGFN, SEFAZ, TST e Caixa, e gera alertas quando detecta riscos — como fornecedores com CNPJ irregular, inscrição estadual suspensa ou divergências em notas fiscais. Em vez de verificar manualmente cada participante, você tem dashboards interativos com a situação fiscal de todos os seus clientes.
                    </div>
                </div>
            </div>
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="funcionalidades">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>O que são as Consultas de CNPJ e como funciona o saldo pré-pago?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="planos">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>Posso testar o FiscalDock antes de adicionar saldo?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="planos">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>Quanto de saldo é ideal para meu escritório?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                <div class="duvidas-answer hidden">
                    <div class="px-6 py-4 text-gray-600 bg-white border-t border-gray-100">
                        Depende do volume de consultas e da rotina do seu time. Escritórios menores podem começar com pouco saldo e adicionar conforme o uso real. Cada consulta tem preço fixo por produto — sem surpresas. <a href="{{ route('precos') }}" data-link class="text-blue-600 hover:underline">Confira nossa página de preços</a> ou fale conosco para uma recomendação personalizada.
                    </div>
                </div>
            </div>
            ...
            <p class="mt-2 mb-6 text-sm text-gray-500">
                ...
                <a href="{{ route('precos') }}" data-link class="hover:underline" style="color: #1e4fa0">Comparar valores e custos por consulta →</a>
            </p>
