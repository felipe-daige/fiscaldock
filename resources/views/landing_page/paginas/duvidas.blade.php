@php
    ...
    $faqs = [
        ...
        ['q' => 'O que são as Consultas de CNPJ e como funciona o sistema de créditos?', 'a' => 'O módulo de Consultas verifica a situação cadastral de CNPJs em lote — tanto participantes extraídos dos SPEDs quanto qualquer CNPJ avulso. Usamos a Receita Federal (consulta gratuita, não consome créditos) e consultas premium em sistemas públicos oficiais (com dados completos, incluindo CND Federal — toda consulta premium consome créditos, inclusive durante o período de teste). O sistema funciona com créditos pré-pagos: cada plano inclui uma cota mensal e você pode comprar pacotes adicionais.'],
        ...
        ['q' => 'O que acontece com meus dados se eu cancelar a assinatura?', 'a' => 'Seus dados permanecem disponíveis por um período após o cancelamento para que você possa exportar relatórios e resumos. Após esse período, os dados são removidos permanentemente. Caso decida voltar, basta reimportar seus arquivos SPED e o sistema reprocessa tudo.'],
        ['q' => 'Posso testar o FiscalDock antes de assinar?', 'a' => 'Sim! O período de teste gratuito inclui importação de SPED, dashboards, alertas e consultas de CNPJ. Você pode importar arquivos reais e avaliar os resultados antes de tomar qualquer decisão. Observações: consultas premium em bases públicas consomem créditos mesmo durante o teste (toda chamada tem custo real); e o módulo de Clearance (validação de notas) ainda está em construção, portanto não está disponível no teste. Também é possível agendar uma demonstração personalizada com nosso time.'],
        ['q' => 'Qual plano é ideal para meu escritório?', 'a' => 'Depende do volume de clientes e das funcionalidades que você precisa. O plano Essencial atende escritórios menores com importação e análise de SPED. O Profissional adiciona consultas premium, validação em lote e dashboards avançados. E o Compliance é para operações com alto volume e necessidades de compliance avançado. Todos incluem créditos para consultas de CNPJ. Confira a página de preços para uma comparação completa.'],
    ];
@endphp
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Encontre respostas sobre importação de SPED, validação fiscal, segurança dos dados e planos
            </p>
        </div>
        ...
        <div class="flex justify-center mb-10">
            <div class="inline-flex flex-wrap justify-center gap-2 bg-gray-50 rounded-lg p-1.5 border border-gray-200">
                ...
                <button class="duvidas-cat-btn px-4 py-2 rounded-md font-semibold text-sm transition-all duration-200 text-gray-600 hover:text-gray-900 hover:bg-white"
                        data-category="planos">Planos e Preços</button>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="seguranca">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>O que acontece com meus dados se eu cancelar a assinatura?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                <div class="duvidas-answer hidden">
                    <div class="px-6 py-4 text-gray-600 bg-white border-t border-gray-100">
                        Seus dados permanecem disponíveis por um período após o cancelamento para que você possa exportar relatórios e resumos. Após esse período, os dados são removidos permanentemente. Caso decida voltar, basta reimportar seus arquivos SPED e o sistema reprocessa tudo.
                    </div>
                </div>
            </div>
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="planos">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>Posso testar o FiscalDock antes de assinar?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div class="duvidas-item border border-gray-200 rounded-lg mb-4 hover:border-blue-500 transition-colors overflow-hidden" data-category="planos">
                <button class="duvidas-question w-full text-left px-6 py-4 font-semibold text-gray-900 hover:text-blue-500 flex justify-between items-center">
                    <span>Qual plano é ideal para meu escritório?</span>
                    <svg class="w-5 h-5 shrink-0 ml-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                <div class="duvidas-answer hidden">
                    <div class="px-6 py-4 text-gray-600 bg-white border-t border-gray-100">
                        Depende do volume de clientes e das funcionalidades que você precisa. O plano Essencial atende escritórios menores com importação e análise de SPED. O Profissional adiciona consultas premium, validação em lote e dashboards avançados. E o Compliance é para operações com alto volume e necessidades de compliance avançado. Todos incluem créditos para consultas de CNPJ. <a href="{{ route('precos') }}" data-link class="text-blue-600 hover:underline">Confira nossa página de preços</a> ou fale conosco para uma recomendação personalizada.
                    </div>
                </div>
            </div>
            ...
            <p class="mt-2 mb-6 text-sm text-gray-500">
                ...
                <a href="{{ route('precos') }}" data-link class="hover:underline" style="color: #1e4fa0">Comparar planos e preços →</a>
            </p>
        ...
        <div class="text-center mt-12 pt-8 border-t border-gray-200 max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center items-center">
                <a href="{{ route('agendar') }}" data-link class="btn-cta">Agendar Demonstração</a>
