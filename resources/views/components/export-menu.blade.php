@props([
    ...
    'titulo' => 'Exportar',
    'descricao' => null,
    'size' => 'sm',            // sm = compacto (barra de seleção) | lg = header
])
...
<button type="button" data-export-menu="{{ $id }}"
    ...
    {{ $attributes->merge(['class' => 'inline-flex items-center justify-center gap-1.5 rounded border border-gray-300 bg-white '.$btnSize.' transition-colors hover:bg-gray-50']) }}>
