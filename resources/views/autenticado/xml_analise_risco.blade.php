{{-- Análise de Risco XMLs - Autenticado --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div>
                <h1 class="text-xl font-bold text-gray-800">
                    Análise de Risco - XMLs
                </h1>
                <p class="text-xs text-gray-500 mt-1">
                    Importe XMLs de notas fiscais e analise o risco dos emissores
                </p>
            </div>
        </div>
    </div>
        ...
        <div id="etapa-upload" class="etapa">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {{-- Card de Importação (2/3 da largura) --}}
                    <div class="lg:col-span-2 bg-white rounded-lg shadow-md p-6">
                        <h2 class="text-lg font-semibold text-gray-800 mb-4">SELECIONAR ARQUIVOS</h2>
                        ...
                        <div class="mb-4">
                            <div id="upload-area" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors cursor-pointer bg-gray-50 hover:bg-blue-50">
                                ...
                                <p class="text-xs text-gray-700 mb-1">Arraste o arquivo XML aqui</p>
                                <p class="text-xs text-gray-500">ou clique para selecionar</p>
                                <p class="text-xs text-gray-500 mt-1">.xml | Máximo: 5MB</p>
                                <input type="file" id="xml-file" name="xml_file" accept=".xml" class="hidden">
                            </div>
                        </div>
                        ...
                        <div id="file-selected" class="mb-4 hidden">
                            <div class="flex items-center justify-between p-2 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div class="text-xs font-medium text-gray-800" id="file-name">arquivo.xml</div>
                    ...
                    {{-- Card de Resumo do Custo (1/3 da largura) --}}
                    <div class="lg:col-span-1 bg-white rounded-lg shadow-md p-6 h-fit lg:sticky lg:top-4">
...
function validarCampos() {
    ...
    const tipoXmlSelecionado = document.querySelector('input[name="tipo-xml"]:checked') !== null;
    const consultasSelecionadas = document.querySelectorAll('.consulta-checkbox:checked').length > 0;
    
    return arquivoSelecionado && tipoXmlSelecionado && consultasSelecionadas;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Tipo de XML - atualizar validação
    document.querySelectorAll('input[name="tipo-xml"]').forEach(radio => {
