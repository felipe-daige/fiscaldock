...
<div class="min-h-screen bg-gray-100" id="minha-empresa-container">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div class="bg-white rounded border border-gray-300 overflow-hidden mb-6 sm:mb-8">
            <div class="bg-gray-50 px-4 py-2 border-b border-gray-200">
                <span class="text-[10px] font-semibold text-gray-500 uppercase tracking-widest">Monitoramento Contínuo</span>
            </div>
            <div class="p-4">
                @if($monitoramento)
                ...
                @else
                    ...
                    <a href="/app/monitoramento/painel" data-link class="bg-gray-800 text-white hover:bg-gray-700 inline-flex items-center justify-center rounded text-sm font-medium px-4 py-2 transition-colors">Monitorar minha empresa</a>
                @endif
            </div>
        </div>
