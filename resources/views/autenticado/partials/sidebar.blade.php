...
<x-sidebar.layout>
    <x-sidebar.section title="VISAO GERAL">
    ...
    <x-sidebar.section title="CONSULTAS E COMPLIANCE">
        <x-sidebar.group title="Consultas" :open="request()->is('app/consulta/*') || request()->is('app/consultas/*')">
            <x-slot:icon>
                <svg class="sidebar__item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-sidebar.group-item href="/app/consulta/nova">Nova</x-sidebar.group-item>
    ...
    <x-sidebar.section title="CADASTROS">
        ...
        <x-sidebar.group title="Clientes" :open="request()->is('app/clientes*') || request()->is('app/novo-cliente*') || request()->is('app/cliente/novo*')">
            <x-slot:icon>
                <svg class="sidebar__item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                </svg>
            ...
            <x-sidebar.group-item href="/app/cliente/novo">Novo</x-sidebar.group-item>
        </x-sidebar.group>

        <x-sidebar.group title="Participantes" :open="request()->is('app/participantes*') || request()->is('app/novo-participante*') || request()->is('app/participante/novo*')">
            <x-slot:icon>
                <svg class="sidebar__item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-sidebar.group-item href="/app/participante/novo">Novo</x-sidebar.group-item>
        </x-sidebar.group>
    </x-sidebar.section>
