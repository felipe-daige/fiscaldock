...
<x-sidebar.layout>
    ...
    <x-sidebar.section title="VALIDAÇÃO">
        <x-sidebar.item href="/app/validacao" :active="request()->is('app/validacao')">
            <x-slot:icon>
                <svg class="sidebar__item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <x-sidebar.item href="/app/validacao/buscar-nfe" :active="request()->is('app/validacao/buscar-nfe*')">
            <x-slot:icon>
                <svg class="sidebar__item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
