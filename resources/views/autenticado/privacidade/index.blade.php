    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        @if($historico->isNotEmpty())
            <div class="bg-white rounded border border-gray-300 mb-5 overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-200 flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('app.privacidade.exportar-csv') }}" class="auth-control shrink-0 inline-flex items-center gap-1 rounded border border-gray-300 text-gray-700 hover:bg-gray-50">
                        Exportar CSV
                    </a>
                </div>
        ...
        <div class="bg-white rounded border border-gray-300 mb-5 overflow-hidden">
            ...
            <div class="p-4 flex items-center justify-between gap-4">
                <p class="text-sm text-gray-600">Baixe um arquivo JSON com seus dados de cadastro, consentimentos e histórico de saldo (art. 18, LGPD). Dados de clientes que você administra aparecem só como contagem.</p>
                <a href="{{ route('app.privacidade.exportar') }}" class="auth-control shrink-0 inline-flex items-center gap-1.5 rounded font-bold uppercase tracking-wide text-white hover:opacity-90" style="background-color: #0b1f3a">
