...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-500 mt-1">Visão geral da sua carteira de participantes</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            {{-- Card 1: Conformidade --}}
            <div class="bg-white rounded-lg border border-gray-200 p-6 dash-animate">
            ...
            {{-- Card 2: Impostos Recuperáveis --}}
            <div class="bg-white rounded-lg border border-gray-200 p-6 dash-animate" style="animation-delay: 0.1s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        @php
                            $impostos = $kpi_impostos_recuperaveis ?? 0;
                        @endphp
                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Créditos Fiscais</p>
                        <p class="text-3xl font-semibold text-gray-900">
                            R$ {{ number_format($impostos, 2, ',', '.') }}
                        </p>
                        <p class="text-xs text-gray-400 mt-2">PIS/COFINS recuperáveis</p>
                    </div>
                    <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center ml-4">
                        <svg class="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- Card 3: Créditos --}}
            <div class="bg-white rounded-lg border border-gray-200 p-6 dash-animate" style="animation-delay: 0.2s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        @php
                            $creditos = $kpi_creditos ?? 0;
                        @endphp
                        <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Créditos</p>
                        <p class="text-3xl font-semibold text-green-600">
                            {{ number_format($creditos, 0, ',', '.') }}
                        </p>
                        <p class="text-xs text-gray-400 mt-2">Disponíveis para consultas</p>
                    </div>
            ...
            {{-- Card 4: Alertas --}}
            <div class="bg-white rounded-lg border border-gray-200 p-6 dash-animate" style="animation-delay: 0.3s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        @php
                        ...
                        <p class="text-xs text-gray-400 mt-2">Requerem atenção</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                {{-- Ações Rápidas --}}
                <div class="bg-white rounded-lg border border-gray-200 dash-animate" style="animation-delay: 0.5s">
                    <div class="px-5 py-4 border-b border-gray-100">
                        <h2 class="text-sm font-semibold text-gray-900">Ações Rápidas</h2>
                    </div>
                    <div class="p-5">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div class="flex items-center gap-3 p-4 rounded-lg border border-dashed border-gray-200 opacity-60 cursor-not-allowed">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-400">Importar XMLs <span class="ml-1.5 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-amber-100 text-amber-700">Em breve</span></p>
                                    <p class="text-xs text-gray-400">NF-e, NFS-e, CT-e</p>
                                </div>
                            </div>

                            <a href="/app/importacao/efd" data-link class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors group">
                            ...
                            <a href="/app/participantes" data-link class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors group">
                                <div class="w-9 h-9 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition-colors">
                                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 dash-animate" style="animation-delay: 0.5s">
                    <div class="px-5 py-3 border-b border-gray-100">
                        <h2 class="text-sm font-semibold text-gray-900">Módulos</h2>
                    </div>
                    <div class="divide-y divide-gray-100">
                        {{-- Nova Consulta --}}
                        ...
                        {{-- Score Fiscal --}}
                        <a href="/app/score-fiscal" data-link class="group flex items-center gap-3 py-2.5 px-4 hover:bg-gray-50 transition-colors">
                            <div class="w-7 h-7 bg-amber-50 rounded-lg flex items-center justify-center">
                                <svg class="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                                </svg>
                            </div>
                            <span class="flex-1 text-sm font-medium text-gray-900">Score Fiscal</span>
                            <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                        ...
                        <a href="/app/validacao" data-link class="group flex items-center gap-3 py-2.5 px-4 hover:bg-gray-50 transition-colors">
                            ...
                            <span class="flex-1 text-sm font-medium text-gray-900">Validação Contábil</span>
                            <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                        ...
                        {{-- BI Fiscal --}}
                        <a href="/app/bi" data-link class="group flex items-center gap-3 py-2.5 px-4 hover:bg-gray-50 transition-colors">
                        ...
                        <a href="/app/consultas/historico" data-link class="group flex items-center gap-3 py-2.5 px-4 hover:bg-gray-50 transition-colors">
                            ...
                            <span class="flex-1 text-sm font-medium text-gray-900">Histórico Consultas</span>
                            <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                        ...
                        <ol class="space-y-3 text-sm">
                            <li class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Importe um arquivo SPED ou adicione os dados manualmente</p>
                                </div>
                            </li>
                            <li class="flex gap-3">
                            ...
                            <li class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Visualize faturamento, tributos e indicadores a partir dos seus SPEDs</p>
                                </div>
                            </li>
                        </ol>
                    </div>
                ...
                {{-- Suporte --}}
                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 dash-animate" style="animation-delay: 0.6s">
