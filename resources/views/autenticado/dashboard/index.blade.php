                ...
                <div class="bg-white rounded-lg border border-gray-200 dash-animate" style="animation-delay: 0.5s">
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <a href="/app/importacao/sped" data-link class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors group">
