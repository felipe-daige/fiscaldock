    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div class="mb-4 sm:mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Selecione notas e dispare a validação contábil em lote.</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200" id="tbody-notas">
                        ...
                        @empty
                            <tr><td colspan="9" class="px-3 py-8 text-center text-sm text-gray-500">Nenhuma nota encontrada com os filtros atuais.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
