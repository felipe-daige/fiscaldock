    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-center gap-2">
                <div id="step-indicator-1" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm font-medium text-gray-700 hidden sm:inline">Importar Arquivo</span>
                </div>
                ...
                <div id="step-indicator-2" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm font-medium text-gray-500 hidden sm:inline">Configurar Análise</span>
                </div>
                <div class="w-12 h-0.5 bg-gray-300"></div>
                <div id="step-indicator-3" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm font-medium text-gray-500 hidden sm:inline">Resultados</span>
                </div>
            </div>
        </div>
        ...
        <div id="etapa-1" class="etapa">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">ETAPA 1 DE 3: IMPORTAR ARQUIVO</h2>
                
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-3">Tipo de SPED:</label>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="flex items-start p-4 border-2 border-blue-600 rounded-lg cursor-pointer bg-blue-50">
                            <input type="radio" name="tipo-sped" value="efd-contrib" checked class="mt-1 mr-3 w-4 h-4 text-blue-600">
                            <div>
                                <div class="font-semibold text-gray-800">EFD Contribuições</div>
                                <div class="text-xs text-gray-600 mt-1">PIS/COFINS</div>
                            </div>
                        </label>
                        <label class="flex items-start p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-400">
                            <input type="radio" name="tipo-sped" value="efd-fiscal" class="mt-1 mr-3 w-4 h-4 text-blue-600">
                            <div>
                                <div class="font-semibold text-gray-800">EFD Fiscal</div>
                                <div class="text-xs text-gray-600 mt-1">ICMS/IPI</div>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div id="upload-area" class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors cursor-pointer bg-gray-50 hover:bg-blue-50">
                        ...
                        <p class="text-sm text-gray-700 mb-2">
                            Arraste o arquivo SPED aqui
                        </p>
                        <p class="text-xs text-gray-500 mb-4">
                            ou clique para selecionar
                        </p>
                        <p class="text-xs text-gray-500">
                            Formato: .txt | Máximo: 50MB
                        </p>
                        <input type="file" id="sped-file" name="sped_file" accept=".txt" class="hidden">
                    </div>
                </div>

                <div id="file-selected" class="mb-6 hidden">
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-sm font-medium text-gray-800" id="file-name">SPED_CONTRIB_202501.txt</div>
                                <div class="text-xs text-gray-500" id="file-size">2.3 MB</div>
                            </div>
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <select id="cliente-select" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex justify-end">
                    <button type="button" id="processar-arquivo-btn" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed" disabled>
                        Processar Arquivo →
                    </button>
                </div>
            </div>
        ...
        {{-- ETAPA 2: Configurar Análise --}}
        <div id="etapa-2" class="etapa hidden">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">ETAPA 2 DE 3: CONFIGURAR ANÁLISE</h2>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <span class="font-semibold text-gray-800 ml-2">ACME COMÉRCIO LTDA</span>
                        </div>
                        <div>
                            <span class="text-gray-600">CNPJ:</span>
                            <span class="font-semibold text-gray-800 ml-2">12.345.678/0001-90</span>
                        </div>
                        <div>
                            <span class="text-gray-600">Período:</span>
                            <span class="font-semibold text-gray-800 ml-2">01/2025</span>
                        </div>
                        <div>
                            <span class="text-gray-600">Fornecedores encontrados:</span>
                            <span class="font-semibold text-gray-800 ml-2">42</span>
                        </div>
                    </div>
                </div>
            </div>
                {{-- Consultas Disponíveis --}}
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4" id="consultas-container">
                            ...
                            <div id="card-listas-restritivas" class="border border-gray-200 rounded-lg shadow-sm bg-white" data-grupo="listas-restritivas">
                                <div class="flex items-center gap-3 p-3 border-b border-gray-200 bg-gray-50 rounded-t-lg">
                            ...
                            <div id="card-restricoes-financeiras" class="border border-gray-200 rounded-lg shadow-sm bg-white" data-grupo="restricoes-financeiras">
                                <div class="flex items-center gap-3 p-3 border-b border-gray-200 bg-gray-50 rounded-t-lg">
            ...
            {{-- Fornecedores a Analisar --}}
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">FORNECEDORES A ANALISAR</h3>
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="py-3 px-4 text-left">
                                        <input type="checkbox" id="select-all-fornecedores" class="w-4 h-4 text-blue-600 border-gray-300 rounded">
                                    </th>
                                    <th class="py-3 px-4 text-left font-semibold text-gray-700">FORNECEDOR</th>
                                    <th class="py-3 px-4 text-left font-semibold text-gray-700">CNPJ</th>
                                    <th class="py-3 px-4 text-right font-semibold text-gray-700">NOTAS</th>
                                </tr>
                            </thead>
                            <tbody id="fornecedores-table-body" class="divide-y divide-gray-200">
                ...
                <div class="mt-3">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" id="select-all-checkbox" class="mr-2 w-4 h-4 text-blue-600 border-gray-300 rounded">
                        <span class="text-sm text-gray-700">Selecionar todos (<span id="total-fornecedores">42</span> fornecedores)</span>
                    </label>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <div class="space-y-2 text-sm mb-4">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">Consultas por fornecedor:</span>
                            <span class="font-semibold text-gray-800" id="resumo-consultas">6</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Total de consultas:</span>
                            <span class="font-semibold text-gray-800" id="resumo-total-consultas">252</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Custo por fornecedor:</span>
                            <span class="font-semibold text-gray-800" id="resumo-custo-fornecedor">R$ 0,54</span>
                        </div>
                        <div class="border-t border-gray-300 pt-2 mt-2">
                            <div class="flex justify-between items-center">
                                <span class="font-semibold text-gray-800">CUSTO TOTAL ESTIMADO:</span>
                                <span class="text-xl font-bold text-amber-600" id="resumo-custo-total">R$ 22,68</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- Botões de Navegação --}}
            <div class="flex justify-between">
                <button type="button" id="voltar-etapa-1" class="px-6 py-2.5 bg-gray-200 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-300 transition-colors">
                    ← Voltar
                </button>
                <button type="button" id="executar-analise-btn" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">
                    Executar Análise →
                </button>
            </div>
        </div>
        ...
        <div id="etapa-3" class="etapa hidden">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">ETAPA 3 DE 3: RESULTADOS DA ANÁLISE</h2>
                        ...
                        <table class="w-full text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="py-3 px-4 text-left font-semibold text-gray-700">FORNECEDOR</th>
                                    <th class="py-3 px-4 text-left font-semibold text-gray-700">CNPJ</th>
                                    <th class="py-3 px-4 text-center font-semibold text-gray-700">SCORE</th>
                                    <th class="py-3 px-4 text-right font-semibold text-gray-700">VALOR</th>
                                    <th class="py-3 px-4 text-center font-semibold text-gray-700">AÇÕES</th>
                                </tr>
                            </thead>
                            <tbody id="resultados-table-body" class="divide-y divide-gray-200">
...
function atualizarIndicadorProgresso(etapa) {
    for (let i = 1; i <= 3; i++) {
        ...
        if (i < etapa) {
            circulo.className = 'w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm font-semibold';
            if (texto) texto.className = 'ml-2 text-sm font-medium text-gray-700 hidden sm:inline';
        } else if (i === etapa) {
            circulo.className = 'w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm font-semibold';
            if (texto) texto.className = 'ml-2 text-sm font-medium text-gray-700 hidden sm:inline';
        } else {
            circulo.className = 'w-8 h-8 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center text-sm font-semibold';
            if (texto) texto.className = 'ml-2 text-sm font-medium text-gray-500 hidden sm:inline';
        }
    }
}
...
function mostrarEtapa(numero) {
    ...
    window.analiseRiscoState.etapa = numero;
    atualizarIndicadorProgresso(numero);
    if (numero === 2) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const processarBtn = document.getElementById('processar-arquivo-btn');
    ...
    processarBtn.addEventListener('click', () => {
        if (window.analiseRiscoState.arquivoSelecionado) {
    ...
    document.getElementById('voltar-etapa-1').addEventListener('click', () => {
        mostrarEtapa(1);
    });

    document.getElementById('executar-analise-btn').addEventListener('click', () => {
        renderizarResultados();
        mostrarEtapa(3);
    });

    document.getElementById('nova-analise-btn').addEventListener('click', () => {
        window.analiseRiscoState.etapa = 1;
        window.analiseRiscoState.arquivoSelecionado = null;
        window.analiseRiscoState.fornecedoresSelecionados = fornecedoresMock.map(f => f.id);
        document.getElementById('file-selected').classList.add('hidden');
        document.getElementById('sped-file').value = '';
        document.getElementById('processar-arquivo-btn').disabled = true;
        mostrarEtapa(1);
    });
    ...
    // Botões Selecionar/Desmarcar todas as consultas
    ...
    document.getElementById('select-all-fornecedores').addEventListener('change', (e) => {
        const checkboxes = document.querySelectorAll('.fornecedor-checkbox');
        checkboxes.forEach(cb => {
            cb.checked = e.target.checked;
            const fornecedorId = parseInt(cb.dataset.id);
            if (e.target.checked) {
                if (!window.analiseRiscoState.fornecedoresSelecionados.includes(fornecedorId)) {
                    window.analiseRiscoState.fornecedoresSelecionados.push(fornecedorId);
                }
            } else {
                window.analiseRiscoState.fornecedoresSelecionados = window.analiseRiscoState.fornecedoresSelecionados.filter(id => id !== fornecedorId);
            }
        });
        atualizarResumoCusto();
    });
    ...
    document.getElementById('select-all-checkbox').addEventListener('change', (e) => {
        const selectAllHeader = document.getElementById('select-all-fornecedores');
    ...
    document.getElementById('buscar-fornecedor').addEventListener('input', (e) => {
        renderizarFornecedores(e.target.value);
    });
...
function renderizarFornecedores(busca = '') {
    const tbody = document.getElementById('fornecedores-table-body');
    tbody.innerHTML = '';
    
    let fornecedoresFiltrados = window.analiseRiscoState.fornecedores;
    if (busca) {
    ...
    fornecedoresFiltrados.forEach(fornecedor => {
        ...
        const isSelected = window.analiseRiscoState.fornecedoresSelecionados.includes(fornecedor.id);
        tr.innerHTML = `
            <td class="py-3 px-4">
                <input type="checkbox" class="fornecedor-checkbox w-4 h-4 text-blue-600 border-gray-300 rounded" 
                       data-id="${fornecedor.id}" ${isSelected ? 'checked' : ''}>
            </td>
            <td class="py-3 px-4 font-medium text-gray-800">${fornecedor.nome}</td>
            <td class="py-3 px-4 text-gray-600">${fornecedor.cnpj}</td>
            <td class="py-3 px-4 text-right text-gray-700">${fornecedor.notas}</td>
        `;
        
        const checkbox = tr.querySelector('.fornecedor-checkbox');
        checkbox.addEventListener('change', (e) => {
            ...
            if (e.target.checked) {
                ...
                window.analiseRiscoState.fornecedoresSelecionados = window.analiseRiscoState.fornecedoresSelecionados.filter(fid => fid !== id);
            }
            atualizarResumoCusto();
        });
...
function atualizarResumoCusto() {
    ...
    const consultasPorFornecedor = consultasSelecionadas.length;
    const custoPorConsulta = consultasSelecionadas.reduce((sum, cb) => sum + parseFloat(cb.dataset.preco), 0);
    const fornecedoresSelecionados = window.analiseRiscoState.fornecedoresSelecionados.length;
    const totalConsultas = fornecedoresSelecionados * consultasPorFornecedor;
    const custoTotal = fornecedoresSelecionados * custoPorConsulta;

    document.getElementById('resumo-consultas').textContent = consultasPorFornecedor;
    document.getElementById('resumo-fornecedores').textContent = fornecedoresSelecionados;
    document.getElementById('resumo-total-consultas').textContent = totalConsultas;
    document.getElementById('resumo-custo-fornecedor').textContent = `R$ ${custoPorConsulta.toFixed(2).replace('.', ',')}`;
...
function renderizarResultados(busca = '', filtroRisco = 'todos') {
    ...
    resultadosPagina.forEach(fornecedor => {
        ...
        const riscoConfig = {
            critico: { icon: '⛔', cor: 'text-red-700', bg: 'bg-red-100' },
            alto: { icon: '🔴', cor: 'text-red-600', bg: 'bg-red-50' },
            medio: { icon: '🟠', cor: 'text-orange-600', bg: 'bg-orange-50' },
            baixo: { icon: '✅', cor: 'text-green-600', bg: 'bg-green-50' }
        };
        ...
        tr.innerHTML = `
            ...
            <td class="py-3 px-4 text-center">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${config.bg} ${config.cor}">
                    ${fornecedor.score}
                </span>
            </td>
            <td class="py-3 px-4 text-right font-medium text-gray-800">R$ ${(fornecedor.valor / 1000).toFixed(0)}k</td>
            <td class="py-3 px-4 text-center">
                <button type="button" class="text-blue-600 hover:text-blue-800 text-sm font-medium ver-detalhes" data-id="${fornecedor.id}">
                    Ver Detalhes
                </button>
            </td>
        `;
        
        tr.querySelector('.ver-detalhes').addEventListener('click', () => {
