...
class VideoDemoSeeder extends Seeder
{
    ...
    private function criarParticipantes(): void
    {
        ...
        $defs = [
            ...
            ['Comercial Nascente ME', '10.111.213/0001-24', 'ATIVA', 'Simples Nacional', 'MS', 'alto'],
            ['Indústria Pioneira Ltda', '14.151.617/0001-28', 'ATIVA', 'Lucro Real', 'PR', 'baixo'],
            ['Distribuidora Safira Ltda', '20.212.223/0001-34', 'ATIVA', 'Lucro Presumido', 'SP', 'baixo'],
            ['Serviços Polaris Ltda', '24.252.627/0001-38', 'ATIVA', 'Simples Nacional', 'MS', 'medio'],
            ['Alimentos Estrela S.A.', '34.353.637/0001-48', 'ATIVA', 'Lucro Real', 'SC', 'baixo'],
            ['Logística Horizonte Ltda', '40.414.243/0001-54', 'ATIVA', 'Lucro Presumido', 'MT', 'baixo'],
