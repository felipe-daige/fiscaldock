(function () {
    ...
    function initEfdImportacaoProgresso() {
        ...
        window._cleanupFunctions.efdImportacaoProgresso = function () {
            finalizado = true;
    ...
    window.initEfdImportacaoProgresso = initEfdImportacaoProgresso;

    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initEfdImportacaoProgresso, { once: true });
    } else {
        initEfdImportacaoProgresso();
    }
})();
