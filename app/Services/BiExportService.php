    ...
    public function contrapartesTabela(array $sec): array
    {
        ...
        foreach ($sec['itens'] ?? [] as $it) {
            ...
            $linhas[] = array_values(array_filter([
                ...
                $it['cnpj'],
                $it['razao'],
                $it['classificacao'] ? ($it['classificacao'] === 'inconclusivo' ? 'não conclusivo' : $it['classificacao']) : \App\Support\Documento::rotuloSemConsulta((string) $it['cnpj'], 'nunca consultado'),
                $it['score_total'] ?? '—',
                $it['volume_brl'],
                $it['notas'],
